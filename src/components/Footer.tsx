        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              UAE-based data analytics and enterprise AI consultancy delivering intelligent transformation.
            </p>
            {/* Social Media Links */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground text-sm">Enterprise Analytics</li>
              <li className="text-muted-foreground text-sm">AI Automation</li>
              <li className="text-muted-foreground text-sm">Predictive Insights</li>
              <li className="text-muted-foreground text-sm">Data Strategy</li>
